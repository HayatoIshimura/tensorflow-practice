...
# 交差エントロピー
sigmoid_cross_entropy_loss = -tf.reduce_sum(label*tf.log(y))

# 最急降下法を使う
train_gradient_decent = tf.train.GradientDescentOptimizer(0.01).minimize(sigmoid_cross_entropy_loss)
